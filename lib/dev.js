...
var test_cal_token_reward = function () {
  var _ref4 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee4() {
    var account_name = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 'eosforce';
    var stat_params, token_list, token_scope, token_reward_promise, token_reward_table, account_data, mineage_update_height;
        ...
        switch (_context4.prev = _context4.next) {
          ...
          case 12:
            ...
            token_list.rows.forEach(function (token_item) {
              ...
              token_item.reward_mine = reward_table || { rows: [] };
            });
            ...
            account_data.rows.forEach(function (my_token) {
              ...
              var multi_num = '1' + balance.split(' ')[0].split('.')[1].split('').map(function (i) {
                return '0';
              }).join('');
              multi_num = parseFloat(multi_num);
              console.log('multi_num is ' + multi_num + ', ' + balance);
              ...
              my_reward_token.reward_mine.rows.forEach(function (reward_record_row) {
                ...
                if (reward_block_num > mineage_update_height) {
                  var today_mineage = (reward_block_num - mineage_update_height) * balance * multi_num + mineage;
...
var test_contract_struct = function () {
  ...
  return function test_contract_struct(_x9) {
...
var abi_bin_to_json = exports.abi_bin_to_json = function () {
  ...
  return function abi_bin_to_json(_x10, _x11, _x12) {
    return _ref8.apply(this, arguments);
  };
}();

// abi_bin_to_json("0000000a5dba3055000000000094b1ca0000000a5dba30551027000000000000044144440000000000", 'relay.token', 'transfer')
...
var test_freeze = function () {
  ...
  return function test_freeze(_x17, _x18, _x19) {
...
var test_claim_token_share = function () {
  ...
  return function test_claim_token_share(_x20, _x21) {
    return _ref17.apply(this, arguments);
  };
}();

// test_claim_token_share(keyProvider, 'eosforce', '0.0000 ADD', 'eosforce');
...
var test_claim_vote_share = function () {
        ...
        switch (_context18.prev = _context18.next) {
          ...
          case 3:
            ...
            return codex_token.transaction(['codex', 'codex.token'], function (contracts) {
              ...
              contracts.codex.claimvote(bpname, voter, { 'actor': voter, 'permission': 'owner' });
            });
  ...
  return function test_claim_vote_share(_x23, _x24, _x25) {
    return _ref18.apply(this, arguments);
  };
}();

// test_claim_vote_share(keyProvider, 'eosforce', 'fb2');
...
var test_get_accounts_by_key = function () {
  ...
  return function test_get_accounts_by_key(_x26) {
...
//     .contract('codex')
//     .then(async token => {
//         let res = await token.vote('testc', 'biosbpa', '1.0000 CDX');
//         console.log(res);
//     })
